...
- 改修内容が書かれている場合は、たとえ軽微な修正であってもROADMAP更新だけを行う
...
1. 必ず自動モードに切り替える
2. 改修内容に不明瞭な点があればヒアリングを行う
3. 明瞭化された改修内容を適切な粒度に分解する
4. 分解した改修内容を [ROADMAP.md](ROADMAP.md) に箇条書きで記載する (サブエージェント`docs-editor`へ委譲)
5. プランモードへ戻る
